...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'lavender': '0 4px 24px rgba(128, 0, 0, 0.30)',
        'ink':      '0 2px 16px rgba(13, 27, 56, 0.10)',
        'wax':      '0 0 0 4px rgba(128, 0, 0, 0.15)',
      ...
      keyframes: {
        ...
        waxPulse:    { '0%,100%': { boxShadow: '0 0 0 0 rgba(128,0,0,0.4)' }, '50%': { boxShadow: '0 0 0 8px rgba(128,0,0,0)' } },
      },
      animation: {
