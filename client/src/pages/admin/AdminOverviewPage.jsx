...
function StatCard({ label, value, accent }) {
  return (
    <motion.div
      ...
      className="bg-[#1a0a0a] border border-[#800000]/12 rounded-sm p-5"
    >
    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <Link
            to="/admin/orders"
            className="font-body text-xs text-[#800000] hover:text-[#b990c7] transition-colors tracking-widest uppercase"
          >
            View All →
          </Link>
        </div>
        ...
        <div className="bg-[#1a0a0a] border border-[#800000]/12 rounded-sm overflow-hidden">
          ...
          {stats?.recent?.map((o, i) => (
            <Link
              ...
              className="flex items-center gap-4 px-5 py-4 border-b border-[#800000]/8 last:border-0 hover:bg-[#800000]/5 transition-colors group"
            >
              ...
              <span className="text-[#FFF8F0]/20 group-hover:text-[#800000]/50 transition-colors">›</span>
            </Link>
          ))}
        </div>
      </div>
